export default function EscalationReasonInput({ value, onChange, isEscalated = false }) {
    return (
        <div className="space-y-2 pt-2 border-t border-slate-100">
            ...
            <input
                ...
                placeholder={
                    isEscalated
                        ? 'e.g. Issue resolved by engineering, reverting to support queue'
                        : 'e.g. SLA breached, customer VIP escalation, blocking core billing system'
                }
